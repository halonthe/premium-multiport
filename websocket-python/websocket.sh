...
Documentation=https://github.com/halonthe/
...
wget -q -O /usr/local/bin/ws-http https://raw.githubusercontent.com/${GitUser}/premium-multiport/main/${namafolder}/ws-http; chmod +x /usr/local/bin/ws-http

# // PYTHON WEBSOCKET OVPN
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/${GitUser}/premium-multiport/main/${namafolder}/ws-ovpn; chmod +x /usr/local/bin/ws-ovpn
