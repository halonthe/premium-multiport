...
VALIDITY () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/${GitUser}/permission/main/premium-multiport/ip | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/${GitUser}/permission/main/premium-multiport/ip | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/premium-multiport/main/cert.sh"
